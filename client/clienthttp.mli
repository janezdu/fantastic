 ...
 * Returns unit *)
val send_post_request: diff_json -> string -> int -> int * string Lwt.t

(* [send_post_request j} sends a get request to the servers. Returns unit *)
val send_get_request: string -> int -> int * string Lwt.t
...
val send_login_request: string -> int * string Lwt.t